...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            // Send Welcome Email
            try {
                // We initiate this but don't block the redirect on it to keep UI snappy, 
                // though for critical emails, waiting is safer. Here we await to ensure it fires.
                ...
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[380px] p-8 border border-white/10 rounded-xl bg-zinc-900/50 backdrop-blur-xl shadow-2xl">
                    <div className="flex flex-col space-y-2 text-center">
                        ...
                        <p className="text-sm text-gray-400">
                            Join the future of media production.
                        </p>
                    </div>
